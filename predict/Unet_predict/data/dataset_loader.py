...
def inputs(data_files, train, batch_size, image_size, 
    ...
    images, filenames = batch_inputs(data_files = data_files, 
...
def batch_inputs(data_files, batch_size, image_size, train, num_epochs, num_preprocess_threads):
    ...
    with tf.name_scope('batch_processing'):
        ...
        color_image, filename = parse_example_proto(example_serialized, IMAGE_FORMAT)
        ...
        if train:
            images, filenames = tf.train.shuffle_batch(
